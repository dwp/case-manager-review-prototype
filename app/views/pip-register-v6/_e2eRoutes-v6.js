...
// health-condition-improved
 router.post(`/${folderForViews}/signposting-eligibility/health-condition-improved`, function (request, response) {
    ...
    if (applysomeoneelse === 'myself') {
      request.session.data['journey'] = 'core';
      response.redirect('/pip-register-v6/signposting-eligibility/need-to-apply-for-PIP');
    } else if (applysomeoneelse === 'someone-else') {
      request.session.data['journey'] = '3rd';
      response.redirect('/pip-register-v6/signposting-eligibility/apply-today');
      } else if (applysomeoneelse === 'got-worse') {
      request.session.data['journey'] = '3rd';
      response.redirect('/pip-register-v6/signposting-eligibility/dla-highest-rate');
    } else {
      response.redirect('/pip-register-v6/signposting-eligibility/health-condition-improved');
    }
  })
